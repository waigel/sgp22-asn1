...
public class AuthenticateClientOkEs11 implements BerType, Serializable {
	...
	public static class EventEntries implements BerType, Serializable {
		...
		private List<com.waigel.sgp22.asn1.rspdefinitions.EventEntries> seqOf = null;
		...
		public List<com.waigel.sgp22.asn1.rspdefinitions.EventEntries> getEventEntries() {
			if (seqOf == null) {
				seqOf = new ArrayList<>();
			}
			return seqOf;
		...
		public int decode(InputStream is, boolean withTag) throws IOException {
			...
			while (vByteCount < lengthVal || lengthVal < 0) {
				...
				if (!berTag.equals(com.waigel.sgp22.asn1.rspdefinitions.EventEntries.tag)) {
					throw new IOException("Tag does not match mandatory sequence of/set of component.");
				}
				com.waigel.sgp22.asn1.rspdefinitions.EventEntries element = new com.waigel.sgp22.asn1.rspdefinitions.EventEntries();
		...
		public void appendAsString(StringBuilder sb, int indentLevel) {
			...
			if (seqOf == null) {
				...
				Iterator<com.waigel.sgp22.asn1.rspdefinitions.EventEntries> it = seqOf.iterator();
				if (it.hasNext()) {
